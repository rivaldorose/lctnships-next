          ...
          <div className="max-w-[760px] mx-auto">
            ...
            <header className="mb-12 lg:mb-16">
              ...
              <div className="flex items-center gap-4 border-y border-gray-100 py-6">
                ...
                />
                <div>
                  <p className="font-bold text-sm tracking-tight">By {article.author.name}</p>
                  <p className="text-gray-500 text-xs font-normal">
                    {article.author.role} • {article.readTime} • {new Date(article.publishedAt).toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' })}
                  </p>
                </div>
              </div>
            </header>
